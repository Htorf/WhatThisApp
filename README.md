...
La partie inférieure est un graphique intéractif, la partie de gauche présente le nombre de message par mois, le chart de droite montre la part de chaque participants. En passant sa souris sur un des mois, le graphique de droite se mets à jour et affiche les sous-totaux pour le mois choisi. En passant sa souris sur un des participants sur le graphique de droite, le chart de gaiche s emet à jour pour afficher le nombre de emssage par mois de cet utilisateur uniquement. 
